...
- Within the same file, callers MUST precede their callees. When an interface and its implementations are declared in the same file, the interface MUST precede its implementations.
