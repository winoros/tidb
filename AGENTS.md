...
3. Comments preserve maintenance-critical knowledge that the code alone does not reliably communicate. Comments MUST follow `docs/agents/code-comment-style-guide.md`.
