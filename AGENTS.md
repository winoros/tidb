...
Full code style rules (Go conventions, test/testdata style, docs style, and the comment style) live in `docs/agents/code-style-guide.md`. That guide and its linked comment guides MUST be consulted when writing, reviewing, or modifying any code, tests, comments, or documentation.
