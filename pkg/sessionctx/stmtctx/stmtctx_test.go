...
func TestResetStmtCtx(t *testing.T) {
	...
	contributorRegistrar := sc.StatementRUUnitContributorRegistrar()
	localCPUWorkRegistrar := sc.StatementRULocalCPUWorkRegistrar()
	require.NotNil(t, unitRecorder)
	require.NotNil(t, evidenceRecorder)
	require.NotNil(t, contributorRegistrar)
	require.NotNil(t, localCPUWorkRegistrar)
	...
	require.Nil(t, sc.StatementRUUnitContributorRegistrar())
	require.Nil(t, sc.StatementRULocalCPUWorkRegistrar())
	require.Same(t, time.UTC, sc.TimeZone())
	require.Same(t, time.UTC, sc.TimeZone())
	require.Equal(t, types.DefaultStmtFlags, sc.TypeFlags())
	require.Equal(t, types.DefaultStmtFlags, sc.TypeFlags())
	...
	require.Equal(t, contributorRegistrar, sc.StatementRUUnitContributorRegistrar())
	require.Equal(t, localCPUWorkRegistrar, sc.StatementRULocalCPUWorkRegistrar())
	require.NotNil(t, sc.TakeStatementRUForExecution())
	sc.ResetForRetry()
	require.Equal(t, unitRecorder, sc.StatementRUUnitRecorder())
	require.Equal(t, evidenceRecorder, sc.StatementRUEvidenceRecorder())
...
func TestStatementRUProducerOverride(t *testing.T) {
	...
	t.Run("routes frozen history to live target and restores", func(t *testing.T) {
		...
		historyLocalCPUWork := history.StatementRULocalCPUWorkRegistrar()
		...
		targetLocalCPUWork := target.StatementRULocalCPUWorkRegistrar()
		...
		require.NoError(t, history.WithStatementRUProducerOverride(target, func() error {
			...
			require.Equal(t, targetLocalCPUWork, history.StatementRULocalCPUWorkRegistrar())
		...
		require.Equal(t, historyLocalCPUWork, history.StatementRULocalCPUWorkRegistrar())
	...
	t.Run("explicit Off does not fall back", func(t *testing.T) {
		...
		require.NoError(t, history.WithStatementRUProducerOverride(nil, func() error {
			...
			require.Nil(t, history.StatementRULocalCPUWorkRegistrar())
			history.ResetForRetry()
			require.Nil(t, history.StatementRUUnitRecorder())
			require.Nil(t, history.StatementRUUnitContributorRegistrar())
			require.Nil(t, history.StatementRULocalCPUWorkRegistrar())
		...
		require.NotNil(t, history.StatementRULocalCPUWorkRegistrar())
	})
