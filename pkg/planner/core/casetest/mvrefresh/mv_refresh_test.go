...
func TestExplainRefreshMVFastPlanTreeMinMax(t *testing.T) {
	...
	require.Equal(t, [][]string{
		...
		{"├─Projection", "8000.00", "root", "", "Column#7, Column#8, Column#9, Column#10, Column#11, Column#12, Column#9, Column#13, Column#11, test.$mlog$t.a, test.mv_tbl_explain_minmax.cnt, test.mv_tbl_explain_minmax.mx, test.mv_tbl_explain_minmax.mn, test.mv_tbl_explain_minmax._tidb_rowid"},
		...
		{"│   └─TableReader(Probe)", "10000.00", "root", "", "data:TableFullScan"},
		{"│     └─TableFullScan", "10000.00", "cop[tikv]", "table:mv", "keep order:false, stats:pseudo"},
		{"└─HashAgg", "0.80", "root", "", "group by:test.t.a, funcs:max(Column#39)->Column#36, funcs:min(Column#40)->Column#37, funcs:firstrow(test.t.a)->test.t.a"},
		...
		{"    └─HashAgg(Probe)", "0.80", "cop[tikv]", "", "group by:test.t.a, funcs:max(test.t.b)->Column#39, funcs:min(test.t.b)->Column#40"},
